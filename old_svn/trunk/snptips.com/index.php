...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<head>
		...
		<!--SubModal-->
		<link rel="stylesheet" type="text/css" href="http://www.5amsolutions.com/about/submodal/subModal.css" />
		<script type="text/javascript" src="http://www.5amsolutions.com/about/submodal/common.js"></script>
		<script type="text/javascript" src="http://www.5amsolutions.com/about/submodal/subModal.js"></script>
		<!--/SubModal-->
	...
	<body id="home">
		...
		<div id="primary_nav">
			...
			<div id="primary_nav_inner">
				...
				<div id="nav">
					...
					<a href="help/">Help</a>
					<a href="https://addons.mozilla.org/en-US/firefox/addon/snptips/versions/" target="_blank">Release Notes</a>
					<a class="submodal-500-450" href="http://pi.pardot.com/l/864/2009-04-01/CI6E4">Get in Touch</a>
				</div>	
				
				<div id="twit">
					<a target="_blank" href="http://www.twitter.com/snptips">Follow us on Twitter &raquo;</a>
				</div>
			...
			<div id="main_inner">
				...
				<div id="focus">
					...
					<div id="install">
						...
						<div id="btn_install">
							...
							<!--<a class="submodal-500-450" href="http://www2.5amsolutions.com/l/864/2011-06-10/KGW9J" onClick="_gaq.push(['_trackEvent', 'xpi', 'download', 'form'])"><img src="images/btn_install.png" alt="Install SNPTips Add-on for Firefox" /></a>-->
							<a href="https://addons.mozilla.org/en-US/firefox/addon/snptips/" onClick="_gaq.push(['_trackEvent', 'xpi', 'download', '1.1'])"><img src="images/btn_install.png" alt="Install SNPTips Add-on for Firefox" /></a>
							
						</div>
							
						<div id="install_info">
						
							<p><strong>SNPTips v1.1</strong></p>
	
							<p>Click the button above to install SNPTips in Firefox 3.5 and up</p>
				...
				<div id="content_col">
					...
					<div id="content">
						...
						<p>SNPTips is a Firefox browser extension that allows customers of the <a href="http://www.23andme.com" target="_blank">23andMe</a> and <a href="http://www.decodeme.com" target="_blank">deCODEme</a> personal genomics services to access their SNP genotype information without leaving the web page they&#8217;re reading.</p>
						
						<p>Ever read a blog post or journal article that mentions a particular SNP, and immediately wonder what your genotype is at that SNP? Rather than opening another browser window or tab, logging in to 23andMe or deCODEme, and searching for the SNP in your data, SNPTips allows you to simply hover your mouse cursor over the SNP RSID in the article text, and a tooltip displays your genotype information immediately! Click the icon next to an RS ID, and a popup also provides smart links to common reference websites, like <a href="http://www.snpedia.com" target="_blank">SNPedia</a>,  <a href="http://scholar.google.com/" target="_blank">Google Scholar</a> and <a href="http://www.ncbi.nlm.nih.gov/projects/SNP/" target="_blank">dbSNP</a>, so you can research the SNP further.</p>
						
						<div class="line"></div>
						
						<h3>Getting Started with SNPTips&trade;</h3>
						
						<p>Need help getting SNPTips configured with your SNP data?  <a href="help/">Click here for instructions</a>.</p>
						
						<div class="line"></div>
						
						<h3>Feedback</h3>
						
						<p>Please let us know if you encounter issues with SNPTips: <a href="mailto:snptips@5amsolutions.com">snptips@5amsolutions.com</a></p>
				...
				<div id="right_col">
					...
					<p style="text-indent:-.4em; padding-left:10px;">*SNPTips is affiliated with neither 23andMe nor deCODEme. SNPTips is a product and a trademark of 5AM Solutions, Inc. 5AM Solutions makes no claims regarding, and is not responsible for, 23andMe&#8217;s or deCODEme&#8217;s content, products, or services.</p>
	
					<p style="text-indent:-.7em; padding-left:10px;">**SNPTips is made available under the <a target="_blank" href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons &ndash; Attribution-ShareAlike 3.0 Unported</a> license. By downloading and installing SNPTips, you agree to be bound by this license.</p>
					
					<p style="padding-left:10px;">Visit <a target="_blank" href="http://www.5amsolutions.com">www.5amsolutions.com</a> for more information on life sciences software.</p>
		...
		<div id="footer">			
			...
			<div id="address">
				...
				SNPTips by <a target="_blank" href="http://www.5amsolutions.com" target="_blank">5AM Solutions</a> <span class="lite bar">|</span>  11710 Plaza America Drive  <span class="lite bar">|</span>  Suite 2000  <span class="lite bar">|</span>  Reston, VA  20190
