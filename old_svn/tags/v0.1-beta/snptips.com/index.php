...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="plugin/snps_files/snptips.css" />
	...
	<body id="home">
			...
			<div id="main_inner">
				...
				<div id="focus">
					...
					<div id="install">
						...
						<div id="btn_install">
							...
							<a href="https://svn.5amsolutions.com/opensource/snptips/tags/v0.1-beta/src/output/v0.1-beta/SNPTips-v0.1-beta.xpi"><img src="images/btn_install.png" /></a>
						
						</div>
							
						<div id="install_info">
						
							<p><strong>SNPTips 0.1 beta</strong></p>
				...
				<div id="focus_example">
					...
					<div id="rsids">
						...
						<span onmouseover="balloon.showTooltip(event, 'load:div_rs_17822931', 1)"><img src="images/rs_17822931.png" /></span>
						&nbsp;&nbsp;&nbsp;
						<span onmouseover="balloon.showTooltip(event, 'load:div_rs_713598', 1)"><img src="images/rs_713598.png" /></span>
				...
				<div id="content_col">
					...
					<div id="content">
						...
						<p class="callout">
							<strong>NOTE</strong>: your raw data is your complete 23andMe SNP profile, and you should take care to safeguard it &ndash; don't download it to a machine you don't control, etc.  If this makes you uncomfortable, SNPTips may not be for you.
						</p>
						...
						<p>You're now ready to browse SNPs!  To try it out, look at the text below - you should see a green box around the SNP RSID:</p>
						
						<p class="callout">
							Hover your mouse cursor over rs17822931 to see if your earwax is wet (CC or CT).  TT's at rs17822931 have dry earwax!
						</p>
		...
		<div class="snptip" style="display:none;" id="div_rs_17822931">
			<div class="snptip_h1">Your genotype at <strong>rs 17822931</strong> is <strong>CC</strong>.</div>
		...
		<div class="snptip" style="display:none;" id="div_rs_713598">
			<div class="snptip_h1"><strong>rs 713598</strong> is not on your chip.</div>
			<div class="snptip_p"><strong>View this SNP at:</strong><br />
