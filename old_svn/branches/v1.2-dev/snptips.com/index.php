	...
	<body id="home">
		...
		<div id="primary_nav">
			...
			<div id="primary_nav_inner">
				...
				<div id="twit">
					<a href="http://www.twitter.com/snptips">Follow us on Twitter &raquo;</a>
				</div>
			...
			<div id="main_inner">
				...
				<div id="focus">
					...
					<div id="install">
						...
						<div id="btn_install">
							...
							<a href="https://addons.mozilla.org/en-US/firefox/addon/snptips/" onClick="_gaq.push(['_trackEvent', 'xpi', 'download', '/xpi/1.0.2-xpi'])"><img src="images/btn_install.png" alt="Install SNPTips Add-on for Firefox" /></a>
				...
				<div id="content_col">
					...
					<div id="content">
						...
						<p>SNPTips is a Firefox browser extension that allows customers of the <a href="http://www.23andme.com" target="_blank">23andMe</a> and <a href="http://www.decodeme.com">deCODEme</a> personal genomics services to access their SNP genotype information without leaving the web page they&#8217;re reading.</p>
