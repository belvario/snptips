...
const SNPTipsConstants = {
    ...
    prefFluidinfoEnabled: "extensions.snptips.fluidinfoEnabled",
    prefDataFile: "extensions.snptips.dataFile",
    elemSnpTipsEnabled: "snptipsEnabled",
    elemFluidinfoEnabled: "fluidinfoEnabled",
...
var snptips = {
	...
	onPageLoad : function(aEvent) {
		var doc = aEvent.originalTarget; // doc is document that triggered
										 // "onload" event
		if (isSNPTipsEnabled()) {
			if(highlightSNPs(doc, getGenomicDataFileContents())) {
...
function loadPreferences() {
	...
	document.getElementById(SNPTipsConstants.elemFluidinfoEnabled).checked = this.isFluidinfoEnabled();
...
function savePreferences() {
	...
	setFluidinfoEnabled(document.getElementById(SNPTipsConstants.elemFluidinfoEnabled).checked);
...
function isFluidinfoEnabled() {
	return prefManager.getBoolPref(SNPTipsConstants.prefFluidinfoEnabled);
}
...
function setFluidinfoEnabled(flag) {
	prefManager.setBoolPref(SNPTipsConstants.prefFluidinfoEnabled, flag);
}
