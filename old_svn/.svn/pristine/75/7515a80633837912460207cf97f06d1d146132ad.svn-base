				...
				<div id="focus">
					...
					<div id="install">
						...
						<div id="btn_install">
							...
							<a href="https://svn.5amsolutions.com/opensource/snptips/releases/latest/SNPTips.xpi" onClick="javascript:pageTracker._trackPageview('/download/1.0.2-xpi');"><img src="images/btn_install.png" /></a>
